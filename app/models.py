...
class Reviews(Base):
    ...
    def __init__(self,
        ...
        assert (type(restaurant_id) is unicode)
        assert (type(restaurant_name))
        assert (type(yelp_restaurant_id))
        assert (type(profile_picture_url))
...
class Restaurants(Base):
    ...
    def __init__(self,
        ...
        assert(type(yelp_id) is unicode)
        assert(type(lat) is float)
        assert(type(city) is unicode)\
        #print(type(address))
        #assert(type(address) is unicode)
        #print(type(phone))
        #assert(type(phone) is unicode or phone is None)
        assert(type(price) is unicode or price is None)
        assert(type(review_count) is int)
        assert(type(url) is unicode)
        #print(type(img_url))
        #assert(type(img_url) is unicode)
        assert(type(food_type) is unicode)
        if(food_type2 is not None) :
            assert(type(food_type2) is unicode)
        if(food_type3 is not None) :
            assert(type(food_type3) is unicode)
